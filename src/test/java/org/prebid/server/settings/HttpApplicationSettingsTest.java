...
public class HttpApplicationSettingsTest extends VertxTest {
    ...
    public void getStoredDataShouldSendHttpRequestWithExpectedNewParams() {
        ...
        // then
        verify(httpClient).get(eq("http://stored-requests?request-ids=[%22id2","id1%22]&imp-ids=[%22id4","id3%22]"),
                any(), anyLong());
    }
    ...
    public void getStoredDataShouldSendHttpRequestWithExpectedAppendedParams() {
        ...
        // then
        verify(httpClient).get(eq("http://some-domain?param1=value1&request-ids=[%22id2","id1%22]&imp-ids=[%22id4","id3%22]"), any(),
                anyLong());
    }
